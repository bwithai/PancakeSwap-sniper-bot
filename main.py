...
print(web3.is_connected(),
      "Web3 connection to the Binance Smart Chain (BSC) is successful and the code is connected to the BSC network.")
...
def handle_event(event):
    # pair = Web3.to_json(event)
    print("\nDetected pair details:")
    token1 = str(Web3.to_json(event['args']['token1']))
    token0 = str(Web3.to_json(event['args']['token0']))
    liquidity_pool_address = str(Web3.to_json(event['args']['pair']))
    transaction_hash = event['transactionHash']
    block = str(Web3.to_json(event['blockNumber']))

    print("Token0: " + token0)
    print("Token1: " + token1)
    print("liquidity_pool_address: " + liquidity_pool_address)
    print("TransactionHash: " + str(Web3.to_json(event['transactionHash'])))
    print("Block: " + block)
    ...
    print("==================================[ Liquidity ]==================================")
    print(f"From Address: {transaction_info['from']}")
    print(f"To Address: {transaction_info['to']}")
...
def main():
    ...
    try:
        ...
        # log_loop(tx_filter, 2)))0x3E89FB7aA8DC4e9E97041C14bC9ee3DEB921BEa9
    finally:
